    ...
    <div className="min-h-screen bg-forest-bg-1">
      ...
      <div className="flex flex-col items-center justify-center px-4 py-16">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
          ...
          <div className="forest-card p-6 text-center">
            <div className="w-16 h-16 bg-gradient-to-r from-forest-accent to-forest-mint rounded-full flex items-center justify-center mx-auto mb-4">
              <Shield className="w-8 h-8 text-forest-bg-1" />
            </div>
            <h3 className="text-xl font-semibold text-forest-text-primary mb-2 font-poppins">Safe Space</h3>
            <p className="text-forest-text-secondary font-inter leading-relaxed">A secure, private environment to express your thoughts and feelings.</p>
          </div>
        </div>
      </div>
    </div>
